# Esame FISM 2026 — Tema 11: Mini corso HTML e CSS

## Scenario

Realizzare un mini sito didattico che spiega concetti base di HTML, CSS e Bootstrap a principianti.
...
Il file data.json contiene lezioni del mini corso con argomento, modulo e attività pratica.
...
Nella pagina in cui vuoi mostrare i dati, ad esempio `lezioni.html`, inserire questi elementi:
...
- `fields.esempio`: Esempio
- `fields.durata`: Durata
