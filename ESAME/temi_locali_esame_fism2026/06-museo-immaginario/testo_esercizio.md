# Esame FISM 2026 — Tema 6: Museo immaginario

## Scenario

Realizzare il sito di un museo immaginario con opere, sale, periodi storici e informazioni per la visita.
...
Il file data.json contiene opere del museo con sala, autore, periodo e materiale.
...
Nella pagina in cui vuoi mostrare i dati, ad esempio `opere.html`, inserire questi elementi:
