# Esame FISM 2026 — Tema 16: Sito di una startup fittizia

## Scenario

Realizzare il sito di una startup immaginaria con prodotto, funzionalità, piani e team.
...
```text
16-sito-di-una-startup-fittizia/
├── testo_esercizio.md
├── script.js
└── data.json
```
...
Il file data.json contiene elementi della startup: funzionalità, piani, servizi e stato di sviluppo.
...
Nella pagina in cui vuoi mostrare i dati, ad esempio `prodotto.html`, inserire questi elementi:
