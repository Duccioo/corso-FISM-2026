...
Realizzare un manuale web introduttivo sulla sicurezza informatica con rischi, consigli e checklist.
...
```text
20-manuale-sicurezza-informatica-base/
├── testo_esercizio.md
├── script.js
└── data.json
```
...
Il file data.json contiene argomenti di sicurezza con rischio, consiglio e target utente.
...
Nella pagina in cui vuoi mostrare i dati, ad esempio `rischi.html`, inserire questi elementi:
...
- `fields.consiglio`: Consiglio
- `fields.utente_target`: Target
