# Esame FISM 2026 — Tema 18: Portfolio personale e CV web

## Scenario

Realizzare un portfolio personale multipagina con progetti, competenze e informazioni professionali fittizie o reali.
...
```text
18-portfolio-personale-e-cv-web/
├── testo_esercizio.md
├── script.js
└── data.json
```
...
Il file data.json contiene progetti e competenze per un portfolio personale/CV web.
...
Nella pagina in cui vuoi mostrare i dati, ad esempio `progetti.html`, inserire questi elementi:
...
- `title`: Elemento
- `category`: Tipo
- `fields.tecnologie`: Tecnologie
- `fields.livello`: Livello
- `fields.anno`: Anno
