# Esame FISM 2026 — Tema 15: Catalogo musicale

## Scenario

Realizzare un catalogo musicale con album, artisti, generi e brani consigliati.
...
Il file data.json contiene album fittizi con artista, genere, anno e brano consigliato.
...
Nella pagina in cui vuoi mostrare i dati, ad esempio `album.html`, inserire questi elementi:
...
- `category`: Genere
- `fields.anno`: Anno
- `fields.brano`: Brano consigliato
