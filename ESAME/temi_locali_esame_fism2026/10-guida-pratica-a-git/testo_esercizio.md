# Esame FISM 2026 — Tema 10: Guida pratica a Git

## Scenario

Realizzare una guida multipagina sui comandi e sui flussi base di Git e GitHub.
...
Il file data.json contiene comandi Git con sintassi, uso e problemi comuni.
...
Nella pagina in cui vuoi mostrare i dati, ad esempio `comandi-git.html`, inserire questi elementi:
...
- `fields.quando_usarlo`: Quando usarlo
- `fields.errore_comune`: Errore comune
