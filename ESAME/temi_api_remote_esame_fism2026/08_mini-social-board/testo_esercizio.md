# Tema 08 — Mini social board

## Obiettivo

Realizzare una bacheca di commenti fittizi usando JSONPlaceholder.

## API remota da usare

API: **JSONPlaceholder**

Documentazione ufficiale: https://jsonplaceholder.typicode.com/guide/
...
| Campo | Significato |
|---|---|
| `name` | Titolo commento |
| `body` | Testo commento |
| `email` | Email fittizia |
| `postId` | ID post |
...
- Mostrare almeno 10 commenti.
- Usare badge per email o ID post.
