# Tema 18 — Media finder

## Obiettivo

Realizzare un catalogo musicale/multimediale usando iTunes Search API.

## API remota da usare

API: **iTunes Search API**

Documentazione ufficiale: https://performance-partners.apple.com/search-api

Endpoint consigliati:

- `https://itunes.apple.com/search?term=queen&media=music&limit=12`

## Campi principali da usare

| Campo | Significato |
|---|---|
| `trackName` | Nome brano |
| `artistName` | Artista |
| `collectionName` | Album |
| `primaryGenreName` | Genere |
| `artworkUrl100` | Copertina |
...
- Mostrare almeno 10 risultati.
- Spiegare come cambiare termine di ricerca o tipo media.
