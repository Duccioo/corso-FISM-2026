# Tema 17 — Vocabolario creativo

## Obiettivo

Realizzare un sito che mostra parole correlate a un tema usando Datamuse.

## API remota da usare

API: **Datamuse API**

Documentazione ufficiale: https://www.datamuse.com/api/

Endpoint consigliati:

- `https://api.datamuse.com/words?ml=computer&max=12`
...
- Mostrare almeno 10 parole correlate.
- Spiegare come cambiare il parametro `ml`.
