# Tema 05 — Pokédex base

## Obiettivo

Realizzare un piccolo Pokédex con card Pokémon, immagini, tipi, altezza e peso.
...
- Mostrare almeno 10 Pokémon.
- Usare immagini ufficiali dalla API.
