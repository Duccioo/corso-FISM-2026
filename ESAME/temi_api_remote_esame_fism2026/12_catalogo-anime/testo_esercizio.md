# Tema 12 — Catalogo anime

## Obiettivo

Realizzare un catalogo anime con titoli, immagini, punteggi e descrizioni.

## API remota da usare

API: **Jikan API v4**

Documentazione ufficiale: https://docs.api.jikan.moe/

Endpoint consigliati:

- `https://api.jikan.moe/v4/anime?q=naruto&limit=12`
...
- Mostrare almeno 8 anime.
- Mostrare punteggio e tipo.
