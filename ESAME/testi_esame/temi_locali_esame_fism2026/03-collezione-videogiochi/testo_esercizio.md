# Esame FISM 2026 — Tema 3: Collezione videogiochi

## Scenario

Realizzare un catalogo multipagina per una collezione di videogiochi, con piattaforme, generi e difficoltà.
...
Il file data.json contiene videogiochi fittizi con genere, piattaforma e dettagli utili per card e tabelle.
...
Nella pagina in cui vuoi mostrare i dati, ad esempio `giochi.html`, inserire questi elementi:
...
- `title`: Gioco
- `category`: Genere
- `fields.piattaforma`: Piattaforma
- `fields.difficolta`: Difficoltà
- `fields.voto`: Voto
