# Esame FISM 2026 — Tema 1: Biblioteca personale

## Scenario

Realizzare un sito multipagina per presentare una piccola biblioteca personale con libri consigliati, generi e informazioni di lettura.
...
Il file data.json contiene un array di libri con autore, genere e dettagli di lettura.
...
Nella pagina in cui vuoi mostrare i dati, ad esempio `libri.html`, inserire questi elementi:
