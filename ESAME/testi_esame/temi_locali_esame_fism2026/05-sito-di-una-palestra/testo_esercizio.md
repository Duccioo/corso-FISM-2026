# Esame FISM 2026 — Tema 5: Sito di una palestra

## Scenario

Realizzare il sito di una palestra con corsi, istruttori, orari e livelli di difficoltà.
...
Il file data.json contiene corsi della palestra con istruttori, orari e livelli.
...
Nella pagina in cui vuoi mostrare i dati, ad esempio `corsi.html`, inserire questi elementi:
...
- `subtitle`: Istruttore
- `category`: Area
- `fields.giorno`: Giorno
- `fields.orario`: Orario
