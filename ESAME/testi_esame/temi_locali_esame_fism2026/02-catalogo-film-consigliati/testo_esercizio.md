# Esame FISM 2026 — Tema 2: Catalogo film consigliati

## Scenario

Realizzare un sito per presentare una selezione di film consigliati, organizzati per genere e valutazione.
...
Il file data.json contiene film fittizi con regia, genere, durata e valutazione.
...
Nella pagina in cui vuoi mostrare i dati, ad esempio `film.html`, inserire questi elementi:
...
- `fields.valutazione`: Valutazione
