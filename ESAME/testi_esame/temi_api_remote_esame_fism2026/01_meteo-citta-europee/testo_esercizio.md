# Tema 01 — Meteo città europee

## Obiettivo

Realizzare un sito che mostra il meteo attuale di alcune città europee usando Open-Meteo.
...
- `https://api.open-meteo.com/v1/forecast?latitude=43.7696&longitude=11.2558&current=temperature_2m,wind_speed_10m,weather_code&timezone=auto`
...
| `current.weather_code` | Codice meteo |
...
- Mostrare almeno 3 città.
- Creare card meteo con temperatura, vento e codice meteo.
