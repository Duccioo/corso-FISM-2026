# Tema 09 — Mini e-commerce

## Obiettivo

Realizzare un catalogo prodotti con prezzi, immagini, categorie e valutazioni.

## API remota da usare

API: **DummyJSON Products**

Documentazione ufficiale: https://dummyjson.com/docs/products
