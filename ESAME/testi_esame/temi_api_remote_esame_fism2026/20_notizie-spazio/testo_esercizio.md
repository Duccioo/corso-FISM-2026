# Tema 20 — Notizie sullo spazio

## Obiettivo

Realizzare una pagina di notizie spaziali usando Spaceflight News API.

## API remota da usare

API: **Spaceflight News API**

Documentazione ufficiale: https://api.spaceflightnewsapi.net/v4/docs/
...
- Mostrare almeno 8 articoli.
- Aggiungere link esterno all articolo quando possibile.
