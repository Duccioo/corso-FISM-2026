# Tema 15 — Calendario festività

## Obiettivo

Realizzare un calendario di festività italiane usando Nager.Date.

## API remota da usare

API: **Nager.Date Holiday API**

Documentazione ufficiale: https://date.nager.at/api

Endpoint consigliati:

- `https://date.nager.at/api/v3/PublicHolidays/2026/IT`
...
| `name` | Nome internazionale |
| `countryCode` | Codice paese |
| `global` | Nazionale/locale |
...
- Mostrare festività italiane 2026.
- Spiegare come cambiare paese o anno nell endpoint.
