# Tema 16 — Dashboard terremoti recenti

## Obiettivo

Realizzare una dashboard con eventi sismici recenti usando USGS.

## API remota da usare

API: **USGS Earthquake Catalog API**

Documentazione ufficiale: https://earthquake.usgs.gov/fdsnws/event/1/
...
| Campo | Significato |
|---|---|
| `features` | Lista eventi |
| `properties.place` | Luogo |
| `properties.mag` | Magnitudo |
| `properties.time` | Tempo |
...
- Mostrare almeno 10 eventi.
- Usare alert o badge per eventi più forti.
