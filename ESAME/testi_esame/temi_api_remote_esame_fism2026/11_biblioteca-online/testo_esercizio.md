# Tema 11 — Biblioteca online

## Obiettivo

Realizzare un catalogo libri usando Open Library.

## API remota da usare

API: **Open Library Search API**

Documentazione ufficiale: https://openlibrary.org/dev/docs/api/search

Endpoint consigliati:

- `https://openlibrary.org/search.json?q=harry+potter&limit=12`
...
| `title` | Titolo |
| `author_name` | Autore |
| `first_publish_year` | Prima pubblicazione |
| `edition_count` | Numero edizioni |
...
- Mostrare almeno 10 libri.
- Spiegare come cambiare la query di ricerca.
