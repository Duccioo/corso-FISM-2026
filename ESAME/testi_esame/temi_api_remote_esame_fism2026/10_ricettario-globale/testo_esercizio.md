# Tema 10 — Ricettario globale

## Obiettivo

Realizzare un ricettario con ricette, categorie, area geografica e ingredienti.
...
| Campo | Significato |
|---|---|
| `strMeal` | Nome ricetta |
| `strCategory` | Categoria |
| `strArea` | Area geografica |
...
- Mostrare ricette legate a una parola chiave.
- Mostrare almeno 3 ingredienti per ricetta.
